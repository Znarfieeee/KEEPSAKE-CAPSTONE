...
const data = {
    ...
    company: {
        name: "KEEPSAKE",
        description:
            "Empowering digital health with thoughtful design and secure innovation. Keepsake helps communities and caregivers manage records with confidence, compassion, and care.",
        logo: Logo,
    },
}
...
export default function Footer4Col() {
    return (
        <footer className="mt-16 w-screen bg-gradient-to-t text-black from-[#c4dee3] to-[#fffafa] rounded-t-xl  dark:bg-secondary/20">
            <div className="mx-auto px-12 pb-6 pt-16 sm:px-6 lg:px-12 lg:pt-24">
                ...
                <div className="mt-12 border-t-1 border-gray-400 pt-6">
