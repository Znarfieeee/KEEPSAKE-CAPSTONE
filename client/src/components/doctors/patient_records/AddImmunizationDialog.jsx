    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 'success') {
                showToast('success', 'Immunization record added successfully')
                onSuccess(response.data)
                onOpenChange(false)
            } else {
                showToast('error', response.message || 'Failed to add immunization record')
            }
        } catch (error) {
            ...
            const errorMessage =
                ...
                error.message ||
                'Failed to add immunization record'
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Add a new vaccination record for{' '}
                        ...
                        <div>
                            ...
                            >
                                <SelectTrigger
                                    ...
                                    className={
                                        errors.route_of_administration ? 'border-red-500' : ''
                                    }
                                >
...
export default AddImmunizationDialog
