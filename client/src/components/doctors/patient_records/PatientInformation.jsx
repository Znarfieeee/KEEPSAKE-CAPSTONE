...
const PatientInformation = ({ patient }) => {
  ...
  return (
    <div className="bg-white rounded-b-lg shadow-sm p-6 mb-6">
      ...
      <div className="mb-10">
        <h2 className="text-lg font-semibold mb-4 mt-4">AUTHORIZED CONTACTS & CAREGIVERS</h2>
        {parentAccessUsers && parentAccessUsers.length > 0 ? (
            ...
            {parentAccessUsers.map((access, index) => {
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-lg border-2 transition-all duration-200 hover:shadow-md ${getRelationshipColor(access.relationship)}`}
                >
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-2">
                      {getRelationshipIcon(access.relationship)}
                      <span className="text-sm font-semibold capitalize text-gray-700">
                        {access.relationship?.replace('_', ' ') || 'Contact'}
                      </span>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {user.phone_number && (
                      <div>
                        <div className="flex items-center space-x-1">
                          ...
                          <label className="text-xs text-gray-600 uppercase tracking-wide">Phone</label>
                        </div>
                        <p className="font-medium text-gray-900">
                          {user.phone_number}
                        </p>
                    ...
                    <div className="pt-2 border-t border-gray-200">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500">Access Status</span>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 text-sm">No authorized contacts or caregivers found</p>
            <p className="text-gray-400 text-xs mt-1">
              Contact information will appear here when parent/guardian access is granted
            </p>
          </div>
        )}
      </div>
