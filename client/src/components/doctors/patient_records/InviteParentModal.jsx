...
import { X, UserPlus, Search, AlertCircle, CheckCircle, Copy, Check } from 'lucide-react'
import {
  searchParents,
...
const InviteParentModal = ({ open, onClose, patient, onSuccess }) => {
  ...
  const handleCreateAndAssign = async (e) => {
    ...
    // Validation
    if (!formData.email || !formData.firstname || !formData.lastname || !formData.relationship) {
    ...
    try {
      ...
      if (response.status === 'success') {
        setGeneratedPassword(response.data.generated_password || response.data.default_password || 'keepsake123')
        showToast('success', response.message || 'Parent account created and assigned successfully')
        if (onSuccess) onSuccess()
      ...
      if (error.status === 409) {
        ...
        const suggestion = error.suggestion || 'This email is already in use. Try using "Assign Existing Parent" instead.'
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
          ...
          <button
            onClick={generatedPassword ? handleCloseAfterSuccess : onClose}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-green-800 mb-4">
                    A parent account has been created for {formData.firstname} {formData.lastname} and assigned to the patient.
                  </p>
                  ...
                  <div className="bg-white rounded-md p-4 border border-green-200">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <span className="text-xs text-gray-600 uppercase tracking-wide block mb-1">Default Password:</span>
                        <div className="flex items-center gap-2">
                  ...
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                    <p className="text-sm text-yellow-800">
                      <strong>Important:</strong> Share these credentials with the parent securely. They will be required to change the password on their first login.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <p>The parent account will be created with the default password: <span className="font-mono font-bold">keepsake123</span></p>
                      <p className="mt-1">The parent will be required to change this password on their first login.</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      onKeyPress={(e) => e.key === 'Enter' && handleSearchParents()}
                      ...
                      {searchResults.map((parent) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              onClick={() => handleAssignExisting(parent)}
                ...
                {searchQuery && searchResults.length === 0 && !searchLoading && (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm mt-1">Try the "Create New Parent" tab to create a new account.</p>
                  </div>
                )}
