...
const PrescriptionQRDialog = ({ isOpen, onClose, prescription, onGenerate = null }) => {
        ...
        try {
            ...
            if (err.message) {
                if (err.message.includes('Patient not found')) {
                    ...
                    errorMessage =
                        "You don't have permission to generate QR codes for this prescription."
            ...
            if (svgElements.length > 0) {
                ...
                await new Promise((resolve, reject) => {
                    qrImg.onload = async () => {
                        ...
                        ctx.fillText(
                            'Scan to access prescription securely',
                            size / 2,
                            y + qrSize + 90
                        )
                        ctx.fillText(
                            `RX #${prescription.rx_id || 'N/A'}`,
                            size / 2,
                            y + qrSize + 110
                        )
                ...
                downloadLink.download = `${prescription.patient_name?.replace(
                    /\s+/g,
                    '_'
                )}_Prescription_QR.png`
        ...
        >
            ...
            >
                ...
                <div className="relative bg-white/98 pt-10 pb-6 px-8 text-center rounded-t-[26px] overflow-hidden">
                    ...
                    <div className="w-[72px] h-[72px] mx-auto mb-4 bg-gradient-to-br from-primary to-accent rounded-[20px] flex items-center justify-center text-white text-4xl shadow-[0_10px_25px_rgba(37,99,235,0.4)] animate-[float_3s_ease-in-out_infinite]">
                        <Pill />
                    </div>
                    ...
                    {!generatedQR && !loading ? (
                                ...
                                {usePinProtection && (
                                    <div className="space-y-3">
                                        ...
                                        <p className="text-xs text-center text-gray-500">
                                            Pharmacists will need this PIN to access prescription
                                            details
                                        </p>
                                    </div>
                                )}
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="text-xs text-amber-700 mt-0.5">
                                                    Recommended for sharing prescription information
                                                    outside trusted pharmacies
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-12 gap-4">
                            ...
                            <span className="text-gray-500 text-[15px]">
                                Generating prescription QR code...
                            </span>
                        </div>
                    ) : error && !generatedQR ? (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-3 gap-3 mb-6">
                                ...
                                <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 rounded-xl flex items-center gap-3 border border-gray-200 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)] hover:border-blue-600">
                                    <Pill className="text-xl text-blue-600 flex-shrink-0" />
                                    <div>
                                        <div className="text-[11px] text-gray-400 uppercase font-semibold tracking-wider mb-0.5">
                                            Medications
                                        </div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-xl mb-6 border border-blue-200">
                                <p className="m-0 text-[13px] text-blue-900 leading-relaxed">
                                    <strong className="text-blue-950">How to use:</strong>{' '}
                                    Pharmacists and healthcare providers can scan this QR code to
                                    securely access the prescription details for{' '}
                                    {prescription?.patient_name}. This includes medications,
                                    dosages, and special instructions.
                                </p>
                            </div>
