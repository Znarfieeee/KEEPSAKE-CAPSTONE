        ...
        <DialogHeader>
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <DialogTitle className="text-2xl font-semibold">{facility.name}</DialogTitle>
            </div>
          </div>
        </DialogHeader>
        ...
        <div className="space-y-6 mt-4">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <InfoItem icon={Hospital} label="Type" value={facility.type} />
              <InfoItem icon={MapPin} label="Location" value={facility.location} />
              <InfoItem icon={Phone} label="Contact" value={facility.contact} />
              <InfoItem icon={Mail} label="Email" value={facility.email} />
              <InfoItem icon={Globe} label="Website" value={facility.website} />
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{facility.admin || '—'}</p>
          </div>
        </div>
