        ...
        <tbody>
          {loading
            ...
            : currentData.map((facility) => (
                <tr key={facility.id} className="border-b border-gray-200 last:border-none">
                  ...
                  <td className="p-2 whitespace-nowrap capitalize">{facility.plan}</td>
                  <td className="p-2 whitespace-nowrap capitalize">{facility.type}</td>
                  ...
                  <td className="p-2 whitespace-nowrap">
                    <div className="flex gap-1">
                      ...
                      <TooltipHelper content="Go-to Facility">
                        <Button variant="ghost" size="icon" onClick={() => onGoto()}>
