...
const NurseAppointments = () => {
    ...
    const [facilityInfo, setFacilityInfo] = useState({ id: null, name: '' })
    ...
    // Initialize Supabase realtime subscription using facilityId
    useAppointmentsRealtime({
        onAppointmentChange: handleAppointmentChange,
        facilityId: facilityInfo.id, // This will filter appointments for this specific facility
    })
    ...
    return (
        <div className="space-y-6 min-h-screen p-6">
            {/* Header with Facility Info and Add Appointment Button */}
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Facility Appointments</h1>
                    <div className="flex items-center gap-2 text-gray-600">
                        <Building2 className="h-4 w-4" />
                        <p>{facilityInfo.name || 'Loading facility...'}</p>
                    </div>
                </div>
