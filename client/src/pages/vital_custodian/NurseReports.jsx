...
const NurseReports = () => {
    ...
    const [filters, setFilters] = useState({
        ...
        roleFilter: 'all', // Not used for nurses, but required by ReportFilters
        exportFormat: null,
    })
    ...
    const filteredData = useMemo(() => {
        ...
        return {
            ...
            recordUpdateTypesData: reportData.recordUpdateTypesData,
        }
        ...
        <div className="min-h-screen bg-gray-50 p-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold mt-1">
                                    {summaryMetrics?.facilityName || 'N/A'}
                                </p>
                            </div>
            ...
            <div className="mb-8">
                <ReportFilters
                    ...
                    onRoleFilterChange={() => {}} // No-op for nurses
                    ...
                    <CardContent className="pt-6">
                        {loading ? (
                            ...
                            <>
                                ...
                                {selectedReport === 'record-update' &&
                                    filteredData.recordUpdateTypesData.length > 0 && (
                                        <ResponsiveContainer width="100%" height={300}>
                                            <PieChart>
                                                <Pie
                                                    data={filteredData.recordUpdateTypesData}
                                                    cx="50%"
                                                    cy="50%"
                                                    labelLine={false}
                                                    ...
                                                    dataKey="value"
                                                >
                                                    {filteredData.recordUpdateTypesData.map(
                                                        (entry, index) => (
                                                            <Cell
                                                                key={`cell-${index}`}
                                                                fill={entry.color}
