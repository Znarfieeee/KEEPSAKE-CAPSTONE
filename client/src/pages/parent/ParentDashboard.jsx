                    ...
                    <CardContent>
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium capitalize">{child.relationship}</span>
                        </div>
                        <div className="flex justify-between">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                You have view-only access to your children's medical records.
                For any updates or changes, please contact your healthcare provider.
              </p>
            </div>
          </div>
        </CardContent>
