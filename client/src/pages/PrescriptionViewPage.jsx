    ...
    const handlePinSubmit = async (pin) => {
        ...
        try {
            ...
            if (patient_data) {
                ...
                const metadata = qr_metadata?.metadata || {}
                const prescriptions = patient_data.prescriptions || []
                let prescription = prescriptions.find(p => p.rx_id === metadata.prescription_id) || prescriptions[0]
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-red-50 to-red-100 flex items-center justify-center p-4">
                <Card className="max-w-md w-full p-8 text-center">
                    ...
                    <Button onClick={() => navigate(-1)} variant="outline" className="flex items-center gap-2 mx-auto">
                        <FiArrowLeft />
                        Go Back
                    </Button>
                </Card>
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
                <Card className="max-w-md w-full p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6">The requested prescription could not be found or has expired.</p>
                    <Button onClick={() => navigate(-1)} variant="outline" className="flex items-center gap-2 mx-auto">
                        <FiArrowLeft />
                        Go Back
                    </Button>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
            ...
            <div className="bg-white shadow-sm border-b sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-gray-900">Prescription Details</h1>
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white py-3">
                    <div className="max-w-4xl mx-auto px-4 flex flex-wrap items-center justify-center gap-6 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span>Uses: {qrMetadata.use_count}/{qrMetadata.max_uses}</span>
                        </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <div ref={printRef} className="bg-white rounded-xl shadow-lg overflow-hidden print:shadow-none">
                    {/* Document Header */}
                    <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-6 print:bg-blue-600">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <img src={KeepsakeLogo} alt="KEEPSAKE" className="h-16 w-16 bg-white rounded-lg p-2" />
                                <div>
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-xl font-mono font-bold">{prescriptionData.rx_id || "N/A"}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <p className="text-xl font-bold text-gray-900">{patientInfo?.name || "Unknown"}</p>
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <p className="text-xl font-bold text-gray-900">{prescriptionData.doctor_name || "N/A"}</p>
                                    <p className="text-gray-600 flex items-center gap-2">
                                        <FiCalendar className="text-gray-400" />
                                        Date: {formatDate(prescriptionData.prescription_date)}
                                    </p>
                                    {prescriptionData.facility_name && (
                                        <p className="text-gray-600">{prescriptionData.facility_name}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                {med.special_instructions && (
                                                    <div className="ml-11 mt-2 p-2 bg-amber-50 border border-amber-200 rounded text-sm">
                                                        <span className="text-amber-800 font-medium">Instructions: </span>
                                                        <span className="text-amber-700">{med.special_instructions}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                    ...
                    {prescriptionData.instructions && (
                        <div className="px-6 pb-6">
                            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                <h4 className="font-semibold text-blue-800 mb-2">Doctor's Instructions</h4>
                    ...
                    {prescriptionData.return_date && (
                        <div className="px-6 pb-6">
                            <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
                                ...
                                <div>
                                    <span className="text-green-700 font-medium">Follow-up Date: </span>
                                    <span className="text-green-900 font-bold">{formatDate(prescriptionData.return_date)}</span>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="bg-gray-100 p-4 text-center border-t">
                        <div className="flex items-center justify-center gap-2 text-gray-500 text-sm">
                            ...
                            <span>This prescription was shared securely via KEEPSAKE Healthcare System</span>
                        </div>
